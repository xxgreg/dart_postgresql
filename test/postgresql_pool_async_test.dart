...
import 'package:postgresql/postgresql_pool_async_impl_cps.dart';
...
_expectAsync() => expectAsync((_){});

main() {
  mockLogger = _log;

  solo_test('Test pool', () => testPool().then(_expectAsync()));
  test('Test start timeout', () => testStartTimeout().then(_expectAsync()));
  test('Test connect timeout', () => testConnectTimeout().then(_expectAsync()));
  test('Test wait queue', () => testWaitQueue().then(_expectAsync()));
